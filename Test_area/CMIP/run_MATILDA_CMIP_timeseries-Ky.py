...
##
parameter = MATILDA.MATILDA_parameter(cmip_dfs[1], set_up_start='2015-01-01 12:00:00', set_up_end='2020-12-31 12:00:00',
                                      sim_start='2021-01-01 12:00:00', sim_end='2100-12-31 12:00:00', freq="Y",
                                      lat=42.25, area_cat=295.76,
                                      area_glac=32.51, ele_dat=2550, ele_glac=4074, ele_cat=3295, lr_temp=-0.005936, lr_prec=-0.0002503,
...
for df, scen in zip(cmip_dfs, scenarios):
    parameter = MATILDA.MATILDA_parameter(df, set_up_start='2015-01-01 12:00:00',
                                          ...
                                          sim_start='2021-01-01 12:00:00', sim_end='2100-12-31 12:00:00', freq="Y",
                                          lat=42.25, area_cat=295.76,
                                          area_glac=32.51, ele_dat=2550, ele_glac=4074, ele_cat=3295, lr_temp=-0.005936,
                                          lr_prec=-0.0002503,
                                          TT_snow=0.354, TT_rain=0.5815, CFMAX_snow=4.824, CFMAX_ice=5.574,
                                          CFR_snow=0.08765,
                                          CFR_ice=0.01132, BETA=2.03, CET=0.0471, FC=462.5, K0=0.03467, K1=0.0544,
                                          K2=0.1277,
